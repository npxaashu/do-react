...
const ProductCard = ({ product, setCartItems }) => {
  ...
  return (
    <div className="group flex flex-col overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-900 transition-all duration-300 hover:-translate-y-1 hover:border-zinc-700 hover:shadow-xl hover:shadow-black/30">
      {/* Image */}
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <div className="mt-auto flex items-center justify-between pt-6">
          ...
          <button
            ...
            className="cursor-pointer rounded-xl bg-emerald-500 px-5 py-2.5 font-medium text-black transition hover:bg-emerald-400 active:scale-95"
          >
            Add to Cart
          </button>
        </div>
